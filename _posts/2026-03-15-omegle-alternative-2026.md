...
- Read a **safety guide** before video: [safety tips for random chat](https://omeglechat.online/safety-tips.html).

## What we built: OmegleChat

**[OmegleChat](https://omeglechat.online/)** is a browser-based random chat — text and video, no install, no account required for basic use. We added dedicated pages for [making friends online](https://omeglechat.online/making-friends.html) and [language learning with strangers](https://omeglechat.online/language-learning.html) because those are the use cases people actually search for.
...
**Try it:** [OmegleChat — free random chat](https://omeglechat.online/)
